...
// White Rectangle Artifact (static, no rotation)
// function RectangleArtifact({ id, position, distance, onRemove }) {
//   const [visible, setVisible] = useState(false);
//   const [opacity, setOpacity] = useState(0);
//   const timerRef = useRef();
...
//     const maxOpacity = Math.max(0.2, 0.4 - distance / 40);
...
//       let opacityValue = 0;
//       const fadeIn = setInterval(() => {
//         opacityValue = Math.min(maxOpacity, opacityValue + 0.02);
//         setOpacity(opacityValue);
//         if (opacityValue >= maxOpacity) clearInterval(fadeIn);
//       }, 30);
//     }, 100);
...
//       let opacityValue = maxOpacity;
//       const fadeOut = setInterval(() => {
//         opacityValue = Math.max(0, opacityValue - 0.02);
//         setOpacity(opacityValue);
//         if (opacityValue <= 0) {
//           clearInterval(fadeOut);
//           setVisible(false);
